return {
  {
    ...
    -- keys = {
    --   { "n", "<C-jj>", ":Treewalker Down<CR>", { noremap = true, silent = true } },
    --   { "n", "<C-kk>", ":Treewalker Up<CR>", { noremap = true, silent = true } },
    --   { "n", "<C-ll>", ":Treewalker Left<CR>", { noremap = true, silent = true } },
    --   { "n", "<C-hh>", ":Treewalker Right<CR>", { noremap = true, silent = true } },
    -- },
